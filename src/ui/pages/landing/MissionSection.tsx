...
const FEATURE_KEYS = [
  'mission.features.aiContent',
  'mission.features.adaptiveLearning',
  'mission.features.gamification',
  'mission.features.sustainability',
] as const
        ...
        >
          <div className="mb-16 text-center">
            ...
            <h2 className="mb-6 font-display text-4xl font-bold text-gray-900 sm:text-5xl">
              {t('mission.heading')}{' '}
              <span className="text-blue-600">{t('mission.headingHighlight')}</span>
            </h2>
            <p className="mx-auto max-w-2xl text-lg text-gray-600">{t('mission.description')}</p>
          </div>
